...
/*!
 @brief Populates versionOut with the current version number of the SDK, e.g. "0.19.2"
 ...
 */
FOUNDATION_EXPORT bool SixDegreesSDK_Initialize(void);
...
/*!
 ...
 @return true if the SDK is initializing, false if there is a problem (check the logs).
 */
FOUNDATION_EXPORT __attribute__((deprecated)) bool SixDegreesSDK_InitializeWithEAGL(void* eaglContext);
